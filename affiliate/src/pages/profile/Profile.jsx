                    ...
                    <form onSubmit={handleProfileUpdate} className="space-y-8">
                          ...
                          <div>
                            ...
                            <div className="flex space-x-3">
                              ...
                              <button
                                ...
                                className="px-4 py-3 bg-theme_color text-white rounded-[5px] transition-colors flex items-center space-x-2"
                              >
                                <FaCopy />
                                <span>Copy</span>
                              </button>
                      ...
                      {isEditing && (
                        <div className="flex justify-end pt-6 border-t border-gray-200">
                          <button
                            type="submit"
                            className="px-8 py-3 bg-theme_color text-white rounded-[5px] font-[500] transition-colors flex items-center space-x-2 cursor-pointer"
                          >
                            <FaSave />
                  ...
                  <div className="space-y-8">
                    ...
                    <form onSubmit={handleCommissionUpdate} className="space-y-8">
                      ...
                      <div className="flex justify-end pt-6 border-t border-gray-200">
                        <button
                          type="submit"
                          className="px-8 py-3 bg-theme_color rouned-[5px] text-white transition-colors flex items-center space-x-2 font-[500] text-[14px]"
                        >
                  ...
                  <div className="space-y-8">
                    ...
                    <form onSubmit={handlePaymentUpdate} className="space-y-8">
                      ...
                      <div className="flex justify-end pt-6 border-t border-gray-200">
                        <button
                          type="submit"
                          className="px-8 py-3 bg-theme_color rounded-[5px] text-white transition-colors flex items-center space-x-2 font-[500] text-[14px]"
                        >
                  ...
                  <div className="space-y-8">
                    ...
                    <form onSubmit={handlePasswordChange} className="w-full space-y-6">
                      ...
                      <div className="flex space-x-3 pt-4">
                        <button
                          type="submit"
                          className="px-6 py-3 bg-theme_color text-white rounded-[5px] cursor-pointer transition-colors flex items-center space-x-2 text-[15px]"
                        >
