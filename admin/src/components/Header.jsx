...
// -------------------logout-funtion---------------------
  ...
  return (
    <header className='w-full h-[9vh] bg-white fixed top-0 left-0 z-[1000] px-[20px] font-nunito py-[10px] flex justify-between items-center shadow-sm border-gray-200'>
     <Toaster/>
      {/* Left Side Logo + Menu */}
      <div className="logo flex justify-start items-center gap-[20px] w-full">
        ...
        <div className="menu text-[25px] cursor-pointer text-gray-700" onClick={toggleSidebar}>
          <HiOutlineMenuAlt2 />
        </div>
      </div>
