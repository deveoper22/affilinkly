...
const AffiliateRegister = () => {
    ...
    switch (paymentMethod) {
      ...
      case 'rocket':
        return (
          <div className="space-y-3">
            <div>
              <label htmlFor={`${paymentMethod}Phone`} className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <input
                ...
                className={`w-full px-3 py-2 md:px-4 md:py-3 bg-white border-[1px] outline-theme_color border-gray-200 rounded-[5px] ${
                  errors[`${paymentMethod}Phone`] ? 'border-red-500' : 'border-gray-200'
            ...
            <div>
              <label htmlFor={`${paymentMethod}AccountType`} className="block text-sm font-medium text-gray-700 mb-2">
                Account Type
              </label>
              <select
                ...
                onChange={handleChange}
                className="w-full px-3 py-2 md:px-4 md:py-3 bg-white border-[1px] outline-theme_color border-gray-200 rounded-[5px] transition duration-200 text-sm md:text-base"
                disabled={loading}
              >
      ...
      case 'binance':
        return (
          <div className="space-y-3">
            <div>
              <label htmlFor="binanceEmail" className="block text-sm font-medium text-gray-700 mb-2">
                Binance Email *
              </label>
              <input
                type="email"
                ...
                onChange={handleChange}
                className={`w-full px-3 py-2 md:px-4 md:py-3 bg-white border-[1px] outline-theme_color border-gray-200 rounded-[5px] ${
                  errors.binanceEmail ? 'border-red-500' : 'border-gray-200'
                } transition duration-200 text-sm md:text-base`}
                disabled={loading}
              />
              {errors.binanceEmail && (
            ...
            <div>
              <label htmlFor="binanceWallet" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div>
              <label htmlFor="binanceId" className="block text-sm font-medium text-gray-700 mb-2">
                Binance ID (Optional)
              </label>
              <input
                type="text"
  ...
  return (
    <div className="min-h-screen font-poppins flex items-center justify-center bg-white p-4">
      ...
      <div className=" p-8 rounded-xl shadow-xl w-full max-w-4xl relative overflow-hidden border border-gray-200">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-2 text-center">Join our affiliate network</p>
          
          {/* Progress Steps */}
          <div className="flex items-center justify-center mt-6 space-x-4">
            <div className={`flex items-center ${step >= 1 ? 'text-emerald-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${step >= 1 ? 'bg-emerald-600 border-emerald-600 text-white' : 'border-gray-300'}`}>
                <span className="text-sm font-medium">1</span>
              </div>
              <span className="ml-2 text-sm">Basic Info</span>
            </div>
            <div className={`w-12 h-0.5 ${step >= 2 ? 'bg-emerald-600' : 'bg-gray-300'}`}></div>
            <div className={`flex items-center ${step >= 2 ? 'text-emerald-600' : 'text-gray-400'}`}>
              <div className={`w-8 h-8 rounded-full flex items-center justify-center border-2 ${step >= 2 ? 'bg-emerald-600 border-emerald-600 text-white' : 'border-gray-300'}`}>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {step === 1 && (
            <div className="space-y-5">
              ...
              <button
                type="button"
                onClick={nextStep}
                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 rounded-[5px] cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 text-sm md:text-base"
                disabled={loading}
              >
                Continue to Payment
              </button>
          ...
          {step === 2 && (
            <div className="space-y-5">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {['bkash', 'nagad', 'rocket', 'binance'].map((method) => (
                    ...
                    >
                      <div className="text-gray-800 font-medium text-sm capitalize">
                        {method === 'bkash' ? 'bKash' : 
                         method === 'nagad' ? 'Nagad' : 
              ...
              <div className="bg-emerald-50 border border-emerald-200 rounded-[5px] p-4">
                <h4 className="text-emerald-700 font-medium mb-2 text-sm">Affiliate Benefits</h4>
              ...
              <div className="flex space-x-3">
                <button
                  type="button"
                  onClick={prevStep}
                  className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-800 font-medium py-3 rounded-[5px] cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-gray-300 text-sm md:text-base"
                  disabled={loading}
                >
                  Back
                </button>
                <button
                  type="submit"
                  className="flex-1 bg-emerald-600 hover:bg-emerald-700 text-white font-medium py-3 rounded-[5px] cursor-pointer transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm md:text-base"
                  disabled={loading}
                >
                  {loading ? (
